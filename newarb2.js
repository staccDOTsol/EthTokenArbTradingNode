                                            ...
                                            for (var currency in body) {
                                                if (body[currency]['currency'] == basesymbol.substring(3, basesymbol.length)) {
												    ...
												    */
                                                    ...
                                                    fee = (0.00215 / (qty * winBp[basesymbol])) + 0.0025;
                                                    console.log('fee: ' + fee);
                                                        ...
                                                        if (threshold >= 0.02) {
                                                            if (basesymbol.startsWith('USDTBTC')) {
                                                                sheet.addRow({
                                                                    'time': formatted,
                                                                    'ticker': basesymbol,
                                                                    'bid': winBp[basesymbol],
                                                                    'ask': winSp[basesymbol2],
                                                                    'arb with fee': arb[basesymbol],
                                                                    'bid ex': winExBp[basesymbol],
                                                                    'ask ex': winExSp[basesymbol],
                                                                    'base threshold': threshold * 60 * 21.27
                                                                }, function(err, row) {});
                                                            ...
                                                            bApi.tradebuy({
                                                                ...
                                                                request(options, function(error, response, body) {
                                                                    ...
                                                                    //console.log (body);
                                                                    bApi.withdraw({
                                                                        currency: basesymbol.substring(3, basesymbol.length),
                                                                        quantity: qty,
