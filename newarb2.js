					...
					for (basesymbol2 in sps){
						if (basesymbol == basesymbol2){
							...
							if (winSp[basesymbol2] != 10 && winBp[basesymbol] != 0 && winSp[basesymbol2] != 1 && winBp[basesymbol] != 1){
								...
								}else if (basesymbol == 'ETHOMG'){
									fee = 0.1662870159453303 + 0.0081361721417304 + 0.0025;
								}else if (basesymbol == 'ETHFUN'){
									fee = 0.0127371273712737 + 0.0081361721417304 + 0.0025;
								}else if (basesymbol == 'ETHADX'){
									fee = 0.0282335654060106 + 0.0081361721417304 + 0.0025;
								}
